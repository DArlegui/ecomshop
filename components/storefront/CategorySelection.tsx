  ...
  return (
    <div className="py-24 sm:py-32">
      <div className="flex justify-between items-center">
        ...
        <Link href="/product/links" className="text-sm font-semibold text-primary hover:text-primary/80">
          Browse all Products &rarr;
        </Link>
      </div>

      <div className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6 lg-gap-6">
        {/* Single column */}
        <div className="group aspect-w-2 aspect-h-1 rounded-xl overflow-hidden sm:aspect-w-1 sm:row-span-2">
          ...
          <div className="bg-gradient-to-b from-transparent to-black opacity-30" />
